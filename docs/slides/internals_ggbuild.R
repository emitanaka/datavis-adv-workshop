# Copy of https://raw.githubusercontent.com/hadley/ggplot2-book/master/internals_gggtable.R
...
# Lines that are marked with # **ET** are those that are inserted by ET
...
ggbuild <- function(plot) {
  ...
  all_steps$reparametrise <- data # **ET**
  ...
  all_steps$compute_geom_2 <- data # **ET**

  # Let layer stat have a final say before rendering
  data <- by_layer(function(l, d) l$finish_statistics(d))
  all_steps$finstat <- data # **ET**
